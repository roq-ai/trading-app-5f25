  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the Power of Smart Investing with Trading App - Implementing Moving Average Cross Over Strategy on Indian Stocks."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1560221328-12fe60f83ab8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzdG9jayUyMHRyYWRpbmd8ZW58MHx8fHwxNjkwODM0NDI0fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@bash__profile?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Nicholas Cappello`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the Power of Smart Investing with Trading App - Implementing Moving Average Cross Over Strategy on Indian Stocks.`}
            </Text>
            <Box
